<template>
  <div class='home'>
    ...
    <div class="main">
        <div class="main-box">
            <!-- <h2>{{list.squareTitle}}</h2> -->
            <ul>
                <li  v-for="(list,index) in shopListData" :key="index"  >
                    <div class="list" @click="jumpDetail(list,index)">
                        <div class="image">
                            <img :src="list.squareUrl" alt="图片">
                        </div>
                        <p class="name">{{list.squareName}}</p>
                        <p class="nametwo">{{list.squareTitle}}</p>
